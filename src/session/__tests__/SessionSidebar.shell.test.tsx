...
function twoOpenSessions(): OpenSession[] {
  return [
    { sid: "sess-active", name: "Active", path: "/sessions/sess-active/session.duck", pendingIngestPaths: [], pendingQuestion: null },
    { sid: "sess-bg", name: "Background", path: "/sessions/sess-bg/session.duck", pendingIngestPaths: [], pendingQuestion: null },
  ];
}
