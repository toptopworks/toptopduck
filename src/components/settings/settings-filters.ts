...
// share. Pure functions and types only -- the Select's option-label JSX stays
// in each pane as literal FormattedMessage children, because formatjs extract
// only matches a direct literal descriptor and would drop ids hoisted here.
...
/** Whether `haystack` (the pane-joined searchable text) contains the query,
