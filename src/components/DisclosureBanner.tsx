...
// inside a collapsible <details>, not an announcement. The <bold> rich-text tag
// is resolved per-message via values.bold -> <strong>, preserving the emphasis
// the prior hard-coded <strong> carried.
