...
pub struct AppConfig {
    ...
    /// pre-existing same-named file keeps its own source (the skills side
    /// retired its side-table posture with ADR-0121; agent definitions carry
    /// no version-following in v1). Forward-compat: a
